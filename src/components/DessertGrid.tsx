...
const DessertGrid: FC = () => {
  ...
  const { selections, data, sortField, sortAsc } = state;
  ...
  useEffect(() => {
    if (
      ...
      allDessertsSelectorRef.current.checked
    ) {
          ...
          <thead onClick={sortByField}>
            <tr>
              <th className={thFirstClassNames}>
                <input
                  className="pv3 bb b--black-20 v-mid"
                  ref={allDessertsSelectorRef}
                  onChange={allRowsSelect}
                  type="checkbox"
                  id="ids"
                  key="ids"
                />
              </th>
              <th className={thSortableClassNames} data-testid="name" id="name">
                Dessert (100g serving)
                <i className={thSortIconsClassNames} aria-hidden="true"></i>
              </th>
              <th className={thSortableClassNames} id="calories">
                Calories
                <i className={thSortIconsClassNames} aria-hidden="true"></i>
              </th>
              <th className={thSortableClassNames} id="fat">
                Fat (g)
                <i className={thSortIconsClassNames} aria-hidden="true"></i>
              </th>
              <th className={thSortableClassNames} id="carbs">
                Carbs (g)
                <i className={thSortIconsClassNames} aria-hidden="true"></i>
              </th>
              <th className={thSortableClassNames} id="protein">
                Protein (g)
                <i className={thSortIconsClassNames} aria-hidden="true"></i>
              </th>
            </tr>
